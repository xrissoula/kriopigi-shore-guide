/** Greek translations for the Geology / Formation page (Field Notes I · Deep Time). */
export const elGeology: Record<string, string> = {
  // --- Page header ---
  ...
  "Beneath Kassandra lie much older rocks that formed in the warm Tethys Ocean during the Mesozoic Era. Marine sediments, volcanic rocks, and fragments of ancient oceanic crust were later caught up in the collision between Africa and Eurasia, becoming part of the geological basement beneath the peninsula. Today these rocks are exposed mainly in southern Kassandra and at depth beneath younger sediments.":
    "Κάτω από την Κασσάνδρα κρύβονται πολύ αρχαιότερα πετρώματα που σχηματίστηκαν στον θερμό ωκεανό της Τηθύος κατά τη Μεσοζωική Εποχή. Θαλάσσια ιζήματα, ηφαιστειακά πετρώματα και θραύσματα αρχαίου ωκεανικού φλοιού ενεπλάκησαν αργότερα στη σύγκρουση μεταξύ Αφρικής και Ευρασίας, γινόμενα μέρος του γεωλογικού υποβάθρου της χερσονήσου. Σήμερα αυτά τα πετρώματα είναι ορατά κυρίως στη νότια Κασσάνδρα και σε βάθος κάτω από νεότερα ιζήματα.",
  ...
  "As the African Plate continued moving northward, it collided with Eurasia, compressing and uplifting the rocks that now form Greece. This mountain-building episode created the Hellenides and established the structural framework on which the Halkidiki peninsulas would later develop.":
    "Καθώς η αφρικανική πλάκα συνέχισε να κινείται προς τα βόρεια, συγκρούστηκε με την ευρασιατική, συμπιέζοντας και ανυψώνοντας τα πετρώματα που σχηματίζουν σήμερα την Ελλάδα. Η ορογένεση αυτή δημιούργησε τις Ελληνίδες Οροσειρές και διαμόρφωσε το δομικό πλαίσιο πάνω στο οποίο θα εξελίσσονταν αργότερα οι χερσόνησοι της Χαλκιδικής.",
  ...
  "Continued uplift, faulting, changing sea levels, and erosion gradually sculpt the Kassandra peninsula. Streams cut valleys into the young sediments, waves carve pocket coves and low cliffs, and beaches shift as sand and gravel move along the shore. Rainwater infiltrating fractured bedrock and overlying sediments re-emerges locally as coastal springs, one of them giving Kriopigi ('cold spring') its name.":
    "Συνεχής ανύψωση, ρηγμάτωση, μεταβαλλόμενες στάθμες θάλασσας και διάβρωση σμιλεύουν σταδιακά τη χερσόνησο της Κασσάνδρας. Τα ρυάκια χαράσσουν κοιλάδες στα νεαρά ιζήματα, τα κύματα λαξεύουν μικρούς όρμους και χαμηλούς γκρεμούς, ενώ οι παραλίες μετατοπίζονται καθώς η άμμος και τα χαλίκια μετακινούνται κατά μήκος της ακτής. Το βρόχινο νερό διηθείται μέσα από ρηγματωμένο υπόστρωμα και υπερκείμενα ιζήματα και επανεμφανίζεται τοπικά ως παράκτιες πηγές, μία από αυτές έδωσε στην Κρυοπηγή το όνομά της («κρύα πηγή»).",
  "Late Pliocene world, continents approach their modern configuration as the Mediterranean nears its present geography and the landscape of Kassandra continues to evolve.":
    "Ο κόσμος του Ύστερου Πλειοκαίνου, οι ήπειροι πλησιάζουν τη σύγχρονη διάταξή τους, η Μεσόγειος πλησιάζει το σημερινό της γεωγραφικό σχήμα και το τοπίο της Κασσάνδρας συνεχίζει να εξελίσσεται.",
  ...
  "The deep story beneath Kassandra": "Η βαθιά ιστορία κάτω από την Κασσάνδρα",
  "The colored zones above are not decoration, they represent different tectonic terranes: fragments of crust with separate geological origins that were compressed and welded together over hundreds of millions of years during the formation of the Hellenides, Greece's mountain system. The Halkidiki peninsulas occupy the southern margin of this tectonic collage, shaped by continental collision, mountain building, uplift, faulting, the closure of the ancient Tethys Ocean, and millions of years of erosion. The landscape you walk through today is the surface expression of that deep geological history.":
    "Οι χρωματισμένες ζώνες στους χάρτες δεν είναι διακοσμητικές, αντιπροσωπεύουν διαφορετικά τεκτονικά τερρέιν: θραύσματα φλοιού με διακριτή γεωλογική προέλευση, που συμπιέστηκαν και συγκολλήθηκαν μεταξύ τους επί εκατοντάδες εκατομμύρια χρόνια κατά τη διαμόρφωση των Ελληνίδων, του ορογραφικού συστήματος της Ελλάδας. Οι χερσόνησοι της Χαλκιδικής αποτελούν τμήμα αυτού του τεκτονικού μωσαϊκού, διαμορφωμένες από ηπειρωτική σύγκρουση, ορογένεση, ανύψωση, ρηγμάτωση, το κλείσιμο του αρχαίου ωκεανού της Τηθύος και εκατομμύρια χρόνια διάβρωσης. Το τοπίο που διασχίζετε σήμερα είναι η επιφανειακή έκφραση αυτής της βαθιάς γεωλογικής ιστορίας.",

  "How geology shapes the coast today": "Πώς η γεωλογία διαμορφώνει την ακτή σήμερα",
  "1. Why the terrain is hilly and dissected": "1. Γιατί το ανάγλυφο είναι τόσο έντονο",
  "Kassandra is an uplifted, faulted peninsula characterized by steep slopes, gullies, drainage cuts, ridges, coves, and irregular shorelines. Mediterranean rainfall often arrives in intense bursts, and winter erosion, sediment transport, and slope instability continue to shape the landscape today.":
    "Η Κασσάνδρα είναι μια ανυψωμένη και ρηγματωμένη χερσόνησος, με απότομες πλαγιές, χαράδρες, απορροές, ράχες, μικρούς όρμους και ακανόνιστες ακτές. Οι μεσογειακές βροχές πέφτουν συχνά με έντονες καταιγίδες, ενώ η χειμερινή διάβρωση, η μεταφορά ιζημάτων και η αστάθεια των πρανών συνεχίζουν να διαμορφώνουν το τοπίο σήμερα.",
  "2. Why the soils are thin and dry": "2. Γιατί τα εδάφη είναι λεπτά και ξηρά",
  "Around Kriopigi, the landscape is developed largely on Neogene and Quaternary sediments resting above older geological basement. The resulting soils are generally thin, well-drained, and prone to summer drought, favoring Aleppo pine, Mediterranean maquis, phrygana, and aromatic shrubs rather than dense temperate forest. These conditions give the landscape its characteristic open, resinous, silver-green appearance.":
    "Γύρω από την Κρυοπηγή, το τοπίο αναπτύσσεται σε μεγάλο βαθμό πάνω σε νεογενή και τεταρτογενή ιζήματα, τα οποία εδράζονται σε παλαιότερο γεωλογικό υπόβαθρο. Τα προκύπτοντα εδάφη είναι γενικά λεπτά, καλά αποστραγγιζόμενα και επιρρεπή στην καλοκαιρινή ξηρασία, ευνοώντας τη χαλέπιο πεύκη, το μεσογειακό μακί, τα φρύγανα και τους αρωματικούς θάμνους αντί για πυκνά εύκρατα δάση. Αυτές οι συνθήκες δίνουν στο τοπίο το χαρακτηριστικό του ανοιχτό, ρητινώδες, ασημοπράσινο παρουσιαστικό.",
  "3. Why the water is so clear": "3. Γιατί το νερό είναι τόσο καθαρό",
  "Low sediment input from the peninsula, together with the naturally oligotrophic waters of the Aegean Sea, results in exceptionally clear water. Without large muddy rivers delivering suspended sediment, light penetrates deeply into the coastal waters, supporting extensive seagrass meadows.":
    "Η χαμηλή εισροή ιζημάτων από τη χερσόνησο, σε συνδυασμό με τα φυσικά ολιγοτροφικά νερά του Αιγαίου, δίνει εξαιρετικά καθαρό νερό. Χωρίς μεγάλους λασπώδεις ποταμούς που μεταφέρουν αιωρούμενα ιζήματα, το φως διαπερνά βαθιά τα παράκτια νερά, υποστηρίζοντας εκτεταμένα λιβάδια Ποσειδωνίας.",
  "4. Why there are springs and cold-water pockets": "4. Γιατί υπάρχουν πηγές και ψυχρά νερά",
  "Faults, fractures, and permeable sedimentary layers channel groundwater through the peninsula. Rainwater infiltrates the subsurface and re-emerges as coastal springs, seepage zones, and localized cold-water upwellings, creating small-scale differences in temperature, salinity, nutrients, fish distribution, and seagrass productivity. Kriopigi, 'the cold spring', takes its name from one of these freshwater sources.":
    "Ρήγματα, κατάγματα και διαπερατά ιζηματογενή στρώματα διοχετεύουν υπόγεια νερά στη χερσόνησο. Το νερό της βροχής διηθείται στο υπέδαφος και επανεμφανίζεται ως παράκτιες πηγές, ζώνες διήθησης και τοπικές ψυχρές αναβλύσεις, δημιουργώντας μικροκλίμακες διαφορές θερμοκρασίας, αλατότητας, θρεπτικών στοιχείων, κατανομής ψαριών και παραγωγικότητας των λιβαδιών της Ποσειδωνίας. Η Κρυοπηγή, «η κρύα πηγή», πήρε το όνομά της από μία από αυτές τις πηγές γλυκού νερού.",
  "5. Why the beaches alternate between sand, pebbles, and rock":
    "5. Γιατί οι παραλίες εναλλάσσονται ανάμεσα σε άμμο, βότσαλα και βράχια",
  "Different rock types and sedimentary deposits erode at different rates. Within a few hundred metres the coast can shift through rocky shelves, pocket coves, coarse gravel beaches, sandy sections, cliffs, and submerged reefs, each one a readout of the rock beneath, the wave exposure above, and the sediment supply between.":
    "Διαφορετικοί τύποι πετρωμάτων και ιζηματογενείς αποθέσεις διαβρώνονται με διαφορετικούς ρυθμούς. Μέσα σε λίγες μόνο εκατοντάδες μέτρα η ακτογραμμή μπορεί να αλλάζει από βραχώδεις εξέδρες σε μικρούς όρμους, παραλίες με χαλίκια ή άμμο, γκρεμούς και βυθισμένους υφάλους. Κάθε τμήμα της αποτελεί αντανάκλαση του πετρώματος από κάτω, της δύναμης των κυμάτων από πάνω και της μεταφοράς των ιζημάτων ανάμεσά τους.",
  ...
  "The forests, shrubs, springs, beach types, erosion patterns, water clarity, and marine habitats around Kriopigi all arise from the same fundamental processes: geology, tectonics, climate, water movement, and time. Read the coast that way and it stops being scenery, it becomes a system.":
    "Τα δάση, οι θαμνώνες, οι πηγές, οι τύποι παραλιών, η διάβρωση, η διαύγεια του νερού και τα θαλάσσια οικοσυστήματα γύρω από την Κρυοπηγή ανάγονται στις ίδιες θεμελιώδεις διεργασίες: γεωλογία, τεκτονική, κλίμα, κίνηση του νερού και χρόνος. Αν διαβάσετε την ακτή μέσα από αυτό το πρίσμα, παύει να είναι απλώς ένα όμορφο τοπίο· γίνεται ένα ζωντανό σύστημα.",
